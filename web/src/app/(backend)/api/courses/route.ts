...
import { getAllCourses, createCourse } from '@/backend/services/course';
import { createCourseSchema } from '@/backend/schemas';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const course = await createCourse({ ...validatedData, backgroundImage: validatedData.backgroundImage || null });
