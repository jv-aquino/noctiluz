...
function MateriaCard({ materia }: MateriaCardProps) {
  return (
    <div className="flex flex-col justify-center items-center gap-4 p-4 rounded-xl border-2 bg-white" style={{ borderColor: materia.cor }}>
      <h3 className="font-bold">{materia.name}</h3>

      <Image src={materia.imgUrl} alt={`Ícone de ${materia.name}`} width={140} height={140} />
